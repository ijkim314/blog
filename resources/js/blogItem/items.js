let items = [
    ...
    {
        productName: '박스 장식-브레이크를 사용한 멀티 라인 스타일링',
        category: 'basic',
        category2: 'text-effect',
        url: 'html/multi-line_box-decoration-break.html',
    },
    {
        productName: 'hidden=until-found를 사용하여 축소된 콘텐츠에 액세스',
        category: 'basic',
        category2: 'navigation-list',
        url: 'html/hidden-until-found.html',
    },
    {
        productName: 'has()를 이용한 overflow 바깥으로 컨텐츠 보이도록',
        category: 'layout',
        url: 'html/overflow_menu_tooltips.html',
    },
    {
        productName: '신문지 같은 레이아웃 잡기',
        category: 'layout',
    ...
    {
        productName: 'IntersectionObserver API를 사용하여 배경 이미지 지연 로드',
        category: 'scroll-parallax',
        category2: 'image',
        url: 'html/lazy_load_background_images_intersectionObserver.html',
    },
    {
        productName: '단일요소 가운데 정렬',
        category: 'layout',
        url: 'html/modern_centering.html',
    },
    {
        productName: 'min() 을 이용한 반응형 가운데 정렬',
        category: 'layout',
        url: 'html/intrinsic_container.html',
    },
    {
        productName: '유연하고 깨지지 않는 상자',
        category: 'layout',
        url: 'html/flexible_unbreakable_boxes.html',
    },
    {
        productName: '스크롤 앵커를 사용한 맨 아래에 머무르기',
        category: 'scroll-parallax',
